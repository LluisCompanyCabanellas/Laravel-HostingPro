        ...
        <div class="desktop-two-columns mobile-two-columns">
            <div class="column">
                <div class="cabecera-logo">
                    <div class="cabecera-logo-imagen">
                        <svg viewBox="0 0 64 64" xml:space="preserve">
                            <rect class="st0" width="64" height="64"/>
                            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="55.7346" y1="54.8275" x2="10.0796" y2="9.1725">
                    ...
                    <div class="cabecera-logo-titulo">
                        <h1>HostingPro</h1>
                    </div>
                </div>
            </div>
            <div class="column"> 
                <div class="cabecera-principal-boton-menu mobile-one-column">
                    <div class="menu-hamburger-button mobile-only" id="menu-hamburger-button">
                        <svg viewBox="0 0 32 22.5">
                            <g class="menu-hamburger-button-svg">
