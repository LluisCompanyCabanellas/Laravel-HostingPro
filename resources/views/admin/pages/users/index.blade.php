            ...
            <div class="desktop-two-columns">
                <div class="column">
                    <div class="panel-button-table edit-button"
                        data-url="{{route('users_edit', ['user' => $user_element->id])}}">
                ...
                <div class="column">
                    <div class="panel-button-table delete-button"
                        data-url="{{route('users_destroy', ['user'=> $user_element->id])}}">
                        <svg viewBox="0 0 24 24">
                            <path fill="currentColor"
        ...
        <div class="column">
            <div class="form-element">
                ...
                <div class="form-element-input">
                    <input class="name" type="text" name="name" value="{{isset($user->name) ? $user->name : ''}}">
                </div>
            </div>
        </div>
    </div>
